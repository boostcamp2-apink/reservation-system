    ...
    <div id="container">
        ...
        <div class="header fade">
            <header class="header_tit">
                ...
                <a href="/myreserve" class="btn_my"> <span title="내 예약">MY</span> </a>
            </header>
        </div>
        <div class="ct">
            <div class="ct_wrap">
                ...
                <div class="section_store_details">
                    <div class="store_details">
                        ...
                        <p class="dsc">
                            장소 : ${product.placeStreet}(${product.placeLot})<br> 기간 : ${product.displayStart}(금)~${product.displayEnd}(화)
                        </p>
                        ...
                        <p class="dsc">
                            <c:forEach var="price" items="${prices}">
                                ${price.description} / ${price.price}원
                                <br>
                            </c:forEach>
                        </p>
                    </div>
                ...
                <div class="section_booking_ticket">
                    <div class="ticket_body _ticketContainer">
                        ...
                        <c:forEach var="price" items="${prices}" varStatus ="status">
                            <div class="qty" id="ticket${status.index}" data-pid = "${price.id}">
                                ...
                                <div class="qty_info_icon">
                                    <strong class="product_amount">
                                        <span>${price.productPriceType}</span> </strong>
                                    ...
                                    <em class="product_dsc">
                                        <span class="discount_price">
                                            <fmt:formatNumber value="${price.price * (100 - price.discountRate) / 100}" pattern="0"/>
                                        </span>원
                                        (${price.discountRate}% 할인가)
                                    </em>
                                </div>
                            </div>
                        </c:forEach>
