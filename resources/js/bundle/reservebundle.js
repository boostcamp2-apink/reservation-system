...
function addReservation(data) {
    ...
    __WEBPACK_IMPORTED_MODULE_0__utils_AjaxWrapper__["b" /* postData */]("/reservations", data).then(function (result) {
        __WEBPACK_IMPORTED_MODULE_1_jquery___default()(location).attr('href', "/reservations");
    });
}
...
function init(callback) {
    numberOfTicket = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(".qty").length;
...
function createTickets(callback) {
    ...
    for (var i = 0; i < numberOfTicket; i++) {
        var ticket = new __WEBPACK_IMPORTED_MODULE_0__components_Ticket__["a" /* default */]("#ticket" + i);
        tickets.push(ticket);
...
class Ticket extends __WEBPACK_IMPORTED_MODULE_0__egjs_component___default.a {

    constructor(rootTarget) {
        super();
        this.rootTarget = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(rootTarget);
        this.countEle = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(rootTarget + " .count_control_input");
        this.price = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(rootTarget + " .price").text();
        this.totalPrice = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(rootTarget + " .total_price");
        this.minusBtn = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(rootTarget + " .ico_minus3");
