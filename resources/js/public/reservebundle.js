...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0)], __WEBPACK_AMD_DEFINE_RESULT__ = function ($) {
    ...
    var postFormFileData = function postFormFileData(url, data) {
...
var _Booker = __webpack_require__(4);

var Booker = _interopRequireWildcard(_Booker);

var _TicketContainer = __webpack_require__(6);

var TicketContainer = _interopRequireWildcard(_TicketContainer);
...
var _reservationModel = __webpack_require__(5);

var reservationModel = _interopRequireWildcard(_reservationModel);
...
var tel = void 0;
var email = void 0;
var agreement = void 0;
var reservBtn = void 0;
var ticketTarget = void 0;
var totalTicket = 0;
var priceTarget = void 0;
var totalPrice = 0;
var isOpen = void 0;

function init() {

    (0, _jquery2.default)("div.agreement > a.btn_agreement").on("click", showAgreement);

    reservBtn = (0, _jquery2.default)(".box_bk_btn .bk_btn_wrap");
    name = (0, _jquery2.default)(".form_wrap #name");
    tel = (0, _jquery2.default)(".form_wrap #tel");
    email = (0, _jquery2.default)(".form_wrap #email");
    agreement = (0, _jquery2.default)('.chk_agree');
    agreement.on("click", function () {
        isValid();
    });
    ticketTarget = (0, _jquery2.default)("span#total_ticket");
    priceTarget = (0, _jquery2.default)("span#total_price");
...
function showAgreement(e) {
    e.preventDefault();
    var target = (0, _jquery2.default)(e.target).closest("div.agreement");
...
function isValid() {
    ...
    if (name.val() != undefined && nf_tel.test(tel.val()) && nf_email.test(email.val()) && totalTicket > 0 && agreement.is(":checked")) {
        reservBtn.removeClass("disable");
        (0, _jquery2.default)(".bk_btn").on("click", postData);
    } else {
        reservBtn.addClass("disable");
        (0, _jquery2.default)(".bk_btn").off("click");
    }
}

function postData() {

    var len = (0, _jquery2.default)(".qty").length;
    var reservationTickets = [];
    for (var i = 0; i < len; i++) {
        reservationTickets[i] = {
            count: (0, _jquery2.default)(".count_control_input").eq(i).val(),
            productPriceId: (0, _jquery2.default)(".qty").eq(i).data("pid")
        };
    }
    var data = {
        productId: 1,
...
var _AjaxWrapper = __webpack_require__(1);

var AjaxWrapper = _interopRequireWildcard(_AjaxWrapper);
...
function addReservation(data) {
    ...
    AjaxWrapper.postData("/reservations", data).then(function (result) {
        (0, _jquery2.default)(location).attr('href', "/reservations");
    });
}
...
var _Ticket = __webpack_require__(7);
...
function init(callback) {
    numberOfTicket = (0, _jquery2.default)(".qty").length;
...
function createTickets(callback) {
    ...
    for (var i = 0; i < numberOfTicket; i++) {
        var ticket = new _Ticket2.default("#ticket" + i);
        tickets.push(ticket);
...
var Ticket = function (_Component) {
    ...
    function Ticket(rootTarget) {
        _classCallCheck(this, Ticket);

        var _this = _possibleConstructorReturn(this, (Ticket.__proto__ || Object.getPrototypeOf(Ticket)).call(this));

        _this.rootTarget = (0, _jquery2.default)(rootTarget);
        _this.countEle = (0, _jquery2.default)(rootTarget + " .count_control_input");
        _this.price = (0, _jquery2.default)(rootTarget + " .price").text();
        _this.totalPrice = (0, _jquery2.default)(rootTarget + " .total_price");
        _this.minusBtn = (0, _jquery2.default)(rootTarget + " .ico_minus3");
