...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [!(function webpackMissingModule() { var e = new Error("Cannot find module \"Extend\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()), !(function webpackMissingModule() { var e = new Error("Cannot find module \"Component\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())], __WEBPACK_AMD_DEFINE_RESULT__ = function (extend, Component) {

    var Slider = extend(Component, {
        "init": function init(rootTarget) {
        ...
        setButton: function setButton(prev, next) {
            this.prev = $(prev);
            this.next = $(next);
            this.clickEvent();
        },

        setFlicking: function setFlicking() {},

        createFakeTarget: function createFakeTarget() {
        ...
        animator: function animator(direction) {
            var moveSize;
            var moveIndex;
            if (direction === "next") {
                moveSize = -this.width;
        ...
        transformAnimate: function transformAnimate(moveSize, moveIndex) {
            this.rootTarget.animate({ move: moveSize }, {
                duration: 1000,
                start: function () {
...
var _ProductComment = __webpack_require__(8);

var ProductComment = _interopRequireWildcard(_ProductComment);

var _ProductDetail = __webpack_require__(38);
...
var _ImagePopup = __webpack_require__(9);
...
var popup = void 0;
var imagePopup = void 0;
var $commentImage = void 0;
...
function setEvent() {
    imagePopup = new _ImagePopup2.default(popup, popup + " ul.visual_img", 'comment-image-template');
...
var _HandlebarsWrapper = __webpack_require__(11);

var HandlebarsWrapper = _interopRequireWildcard(_HandlebarsWrapper);
...
var ImagePopup = function (_Component) {
    _inherits(ImagePopup, _Component);

    function ImagePopup(rootTarget, dataTarget, handleBarsId) {
        _classCallCheck(this, ImagePopup);

        var _this = _possibleConstructorReturn(this, (ImagePopup.__proto__ || Object.getPrototypeOf(ImagePopup)).call(this));

        _this.rootTarget = $(rootTarget);
        _this.dataTarget = $(dataTarget);
        _this.handleBarsId = handleBarsId;
        _this.close = _this.rootTarget.find(".popup_close");
        _this.totalImageNum = _this.rootTarget.find(".popup_total_image_num");
        _this.currentImageNum = _this.rootTarget.find(".popup_image_num");
        _this.slider = _this.setSlider();
        _this.setEvent();

        return _this;
    }

    _createClass(ImagePopup, [{
        key: "setSlider",
        value: function setSlider() {
            var slider = new _Slider2.default(this.dataTarget);
            slider.on("change", this.updateImageCount.bind(this));
            return slider;
        }
    }, {
        key: "setSliderButton",
        value: function setSliderButton(prev, next) {
            this.slider.setButton(prev, next);
        }
    }, {
        key: "setSliderFlicking",
        value: function setSliderFlicking() {
            this.slider.setFlicking();
        }
    }, {
        key: "popupData",
        value: function popupData(data) {
        ...
        key: "updateImageCount",
        value: function updateImageCount(data) {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(12)], __WEBPACK_AMD_DEFINE_RESULT__ = function (Handlebars) {
    var position;
    var source;
    var template;
    var cache = {};

    var createTemplate = function createTemplate(handlebarsId) {
    ...
    return {
        create: function create(handlebarsId, data, method, target) {
        ...
        customHelper: function customHelper(helperName, func) {
            Handlebars.registerHelper(helperName, func);
        },
        setPartial: function setPartial(partialName, partialHandlebarsId) {
...
var _handlebarsNoConflict = __webpack_require__(4);
...
function setEvent() {
    slider = new _Slider2.default(root + ' ul.visual_img');
